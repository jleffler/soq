...
error message.
To avoid repetition, you should pass a variable that points
to the file name to the open function, and can then use that variable
when formatting the error message too.
