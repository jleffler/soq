/*
** Code vaguely related to SO 3038-8085
**
** Demonstrate the use of fwide() and wint_t etc.
**
** Code of uncertain origin, probably not written by Jonathan Leffler,
** but probably modified by Jonathan Leffler.
*/
#include <locale.h>
#include <stdio.h>
#include <stdlib.h>
