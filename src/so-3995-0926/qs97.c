...
int main(void)
{
    ...
    printf("Bounds test 1 (sorting indexes 3..5):\n");
    int data1[] = { +999, +998, +997, 6, 3, 3, -997, -998, -999 };
    dump_list("UNSORTED DATA", data1, 0, 8);
    dump_list("UNSORTED LIST", data1, 3, 5);
    quicksort(myList, 3, 5);
    dump_list("SORTED LIST", data1, 3, 5);
    dump_list("SORTED DATA", data1, 0, 8);

    printf("Bounds test 2 (sorting indexes 3..5):\n");
    int data2[] = { -999, -998, -997, 6, 3, 3, +997, +998, +999 };
    dump_list("UNSORTED DATA", data2, 0, 8);
    dump_list("UNSORTED LIST", data2, 3, 5);
    quicksort(myList, 3, 5);
    dump_list("SORTED LIST", data2, 3, 5);
    dump_list("SORTED DATA", data2, 0, 8);
